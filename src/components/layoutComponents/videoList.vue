  ...
  <div class="leftbox-widget">
    <div class="page-widget rightlayout" v-show="!$store.state.chooseBox.isShow">
      ...
      <ul class="chooselayout chooseProList clearfloat" >
        <li :class="{'nowChoose': alldata.pages[nowPageIndex].module[seleIndex].layout == 'vVideoList__1'}" @click="$store.commit('choose_layout','vVideoList__1')" ><img src="/design/images/default/provideo1.png" alt=""> </li>
        <li :class="{'nowChoose': alldata.pages[nowPageIndex].module[seleIndex].layout == 'vVideoList__2'}" @click="$store.commit('choose_layout','vVideoList__2')"> <img src="/design/images/default/provideo2.png" alt=""></li>
      </ul>
    ...
    <div class="rightlayout widget-widget" v-show="$store.state.chooseBox.isShow">
      <ul class="set">
        <li>上下间距：<input type="number" class="number" min="0" v-model="alldata.pages[nowPageIndex].module[seleIndex].style.margin"></li>
      </ul>
    </div>
  </div>
