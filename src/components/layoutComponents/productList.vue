  ...
  <div class="leftbox-widget">
    <div class="page-widget rightlayout" v-show="!$store.state.chooseBox.isShow">
      ...
      <ul class="chooselayout chooseProList clearfloat" >
        <li :class="{'nowChoose': alldata.pages[nowPageIndex].module[seleIndex].layout == 'vProductList__1'}" @click="$store.commit('choose_layout','vProductList__1')" ><img src="/design/default/prolist1.png" alt=""> </li>
        <li :class="{'nowChoose': alldata.pages[nowPageIndex].module[seleIndex].layout == 'vProductList__2'}" @click="$store.commit('choose_layout','vProductList__2')"> <img src="/design/default/prolist2.png" alt=""></li>
      </ul>
