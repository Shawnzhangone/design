<template>
  <div class="productlist clearfloat" id="pro">
    <div class="filterbox">
      <ul>
        <li class="nownavitem">默认</li>
        <li>排序1</li>
        <li>排序2</li>
        <li>排序3</li>
        <li>排序4</li>
    ...
    <div class="productitem clearfloat" :class="pData.layout" v-for="item in $store.state.defaultData.vProductList[imgdata]" :style="{marginBottom:pData.style.margin__bottom+'px'}">
...
<style scoped="">
 ...
 .vProductList__1 .productimg{
    float: left;margin-right: 6px;width: 35%;
  }
 .vProductList__1 .infobox{
    float:left;width: 62%;
  }
 .vProductList__1 .quantity{
    position: absolute;
    bottom:0px;
  }
 .vProductList__2{
 ...
 .vProductList__2:nth-child(2n){
    margin-right:2%;
  }
.vProductList__2 .productimg{
    width:100%;
  }
.vProductList__2 .icon{
